...
public class dpharmap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(dpharmap.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(dpharmap.this));
