...
public class bpharmap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bpharmap);
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(bpharmap.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(bpharmap.this));
