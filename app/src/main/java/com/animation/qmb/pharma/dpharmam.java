package com.animation.qmb.pharma;
...
public class dpharmam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dpharmam);
        ...
        subjectAdapter = new subjectAdapter(dpharmam.this,filelinks);
        progressDialog.show();
        listView.setLayoutManager(new LinearLayoutManager(dpharmam.this));
