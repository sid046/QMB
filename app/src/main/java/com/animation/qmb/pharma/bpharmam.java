...
public class bpharmam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bpharmam);
        ...
        subjectAdapter = new subjectAdapter(bpharmam.this,filelinks);
        progressDialog.show();
        listView.setLayoutManager(new LinearLayoutManager(bpharmam.this));
