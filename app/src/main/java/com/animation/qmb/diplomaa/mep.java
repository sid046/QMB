...
public class mep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(mep.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(mep.this));
