...
public class bcap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(bcap.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(bcap.this));
