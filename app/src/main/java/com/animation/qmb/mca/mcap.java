...
public class mcap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(com.animation.qmb.mca.mcap.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(com.animation.qmb.mca.mcap.this));
