...
public class bjmcp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(com.animation.qmb.management.bjmcp.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(com.animation.qmb.management.bjmcp.this));
