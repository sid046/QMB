...
public class mbap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(com.animation.qmb.management.mbap.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(com.animation.qmb.management.mbap.this));
