...
public class bbap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(com.animation.qmb.management.bbap.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(com.animation.qmb.management.bbap.this));
