...
public class grp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(com.animation.qmb.bsc.grp.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(com.animation.qmb.bsc.grp.this));
