...
public class nutp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(com.animation.qmb.bsc.nutp.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(com.animation.qmb.bsc.nutp.this));
