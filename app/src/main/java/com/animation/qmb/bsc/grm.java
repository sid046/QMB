...
public class grm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subjectAdapter = new subjectAdapter(grm.this,filelinks);
        progressDialog.show();
        listView.setLayoutManager(new LinearLayoutManager(grm.this));
