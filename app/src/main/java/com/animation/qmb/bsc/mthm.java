...
public class mthm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subjectAdapter = new subjectAdapter(mthm.this,filelinks);
        progressDialog.show();
        listView.setLayoutManager(new LinearLayoutManager(mthm.this));
