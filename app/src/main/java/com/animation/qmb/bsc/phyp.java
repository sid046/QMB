...
public class phyp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(com.animation.qmb.bsc.phyp.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(com.animation.qmb.bsc.phyp.this));
