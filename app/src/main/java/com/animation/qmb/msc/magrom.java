...
public class magrom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subjectAdapter = new subjectAdapter(magrom.this,filelinks);
        progressDialog.show();
        listView.setLayoutManager(new LinearLayoutManager(magrom.this));
