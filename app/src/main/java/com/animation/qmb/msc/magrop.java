...
public class magrop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(magrop.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(magrop.this));
