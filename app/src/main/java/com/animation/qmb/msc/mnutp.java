...
public class mnutp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(mnutp.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(mnutp.this));
