...
public class mcsep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(mcsep.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(mcsep.this));
