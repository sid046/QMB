...
public class mmep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(mmep.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(mmep.this));
