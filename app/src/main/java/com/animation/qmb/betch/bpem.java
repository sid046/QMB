...
public class bpem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subjectAdapter = new subjectAdapter(bpem.this,filelinks);
        progressDialog.show();
        listView.setLayoutManager(new LinearLayoutManager(bpem.this));
