...
public class bmtep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(bmtep.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(bmtep.this));
