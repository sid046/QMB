...
public class bcsep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bcsep);
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(bcsep.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(bcsep.this));
