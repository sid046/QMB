...
public class bcsem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bcsem);
        ...
        subjectAdapter = new subjectAdapter(bcsem.this,filelinks);
        progressDialog.show();
        listView.setLayoutManager(new LinearLayoutManager(bcsem.this));
