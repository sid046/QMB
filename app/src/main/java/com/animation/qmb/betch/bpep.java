...
public class bpep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(bpep.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(bpep.this));
