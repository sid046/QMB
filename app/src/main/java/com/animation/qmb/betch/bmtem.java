...
public class bmtem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subjectAdapter = new subjectAdapter(bmtem.this,filelinks);
        progressDialog.show();
        listView.setLayoutManager(new LinearLayoutManager(bmtem.this));
