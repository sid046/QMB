...
public class bmep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        QuestionModel = new QuestionModel(bmep.this,filelinks);
        listView.setLayoutManager(new LinearLayoutManager(bmep.this));
